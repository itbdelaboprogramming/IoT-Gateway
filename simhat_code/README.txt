'''
#title           :README.txt
#description     :instruction manual for SIMHAT module installation (software)
#author          :Nicholas Putra Rihandoko
#date            :2023/04/20
#version         :1.1
#usage           :Iot Gateway
#notes           :the whole scripts also include configurations for routing capability (RPi as router)
#==============================================================================
'''
...
SIMハット（ハードウェア）モジュールを初めてインストールしたら、RaspberryPiの電源を入れ、
