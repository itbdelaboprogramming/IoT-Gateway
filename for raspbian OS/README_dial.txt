...
For first installation, copy the source code (.7z .sh .txt .deb) on directory "/home/$(logname)/" or "~/"
...
初回インストール時は、ソースコード（.7z .sh .txt .deb）をディレクトリ「/home/$(logname)/」または「~/」にコピーします。
